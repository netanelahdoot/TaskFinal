...
namespace course
{
    public class WorkShift
    {
        ...
        public WorkShift(DateTime start, DateTime end, Worker worker, List<Costumer> costumers, string index)
        {
            this.start = start;
            this.end = end;
            this.worker = worker;
            ...
            this.index = index;
            this.costumersLine = new Queue<Costumer>();
        }
        public WorkShift(DateTime start, Worker worker, string index)
        {
            this.start = start;
